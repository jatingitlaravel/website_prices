...
class PopupGroupFilter
{
	...
	private $hasSubPopups = array();

	public function getHasSubPopups()
	{
		return apply_filters('ypmHasSubPopups', $this->hasSubPopups);
	}
	...
	public function filterByOrder()
	{
		...
		foreach ($popups as $popup) {
			...
			$orderId = $popup->getOptionValue('ypm-popup-order');
